...
function Register() {
    ...
    const handleRegisterOnClick = () => {
        ...
        todoRegisterMutation.mutateAsync(todo);
    }
                ...
                <ul css={s.listGroup}>
                    ...
                    <li css={s.liButton} onClick={handlePrioritySelectOnClick}>
                        ...
                        <div>
                            ...
                            <div>
                                <svg data-dc-tpl="280" width="7" height="12" viewBox="0 0 7 12" fill="none"><path data-dc-tpl="281" d="M1 1l5 5-5 5" stroke="#C7C7CC" stroke-width="1.8" stroke-linecap="round"></path></svg>
                            </div>
                        </div>
                    </li>
                    <li css={s.liButton}>
